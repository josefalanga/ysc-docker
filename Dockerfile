...
RUN apt install -y git libc6 libgcc1 libgcc-s1 libgssapi-krb5-2 libicu55 libicu60 libicu66 libicu70 libicu71 liblttng-ust1 libssl1.0.0 libssl1.1 libssl3 libstdc++6 libunwind8 zlib1g
